...
- ✅ 357 Tests defined (unit + integration; see Testing Guide for breakdown)
...
metrics = ["prometheus", "lazy_static"]   # Prometheus metrics
database = ["sqlx"]                       # SQLite persistence + migrations
fast-allocator = ["mimalloc"]             # High-performance global allocator
gssapi = ["libgssapi"]                    # Optional Kerberos/GSS-API auth
```
...
**Latest** (2025-11-01):
- **Tests**: 357 defined (106 unit + 251 integration/E2E; 10 comprehensive E2E scenarios)
...
|-----------|-------|----------|
| ACL Engine & API | 74 | >90% |
| Authentication / LDAP | 25 | >85% (requires PAM/SSSD services) |
| QoS | 36 | >90% |
| Connection Pool | 27 | ~100% (includes stress/ignored tests) |
| Session Manager & Resolver | 39 | >85% |
| Protocol / Transport | 31 | >85% |
