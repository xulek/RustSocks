...
If you've enabled dashboard authentication via `[sessions.dashboard_auth]`, the UI will prompt for the configured credentials (or you can curl the dashboard with `curl -u user:pass http://localhost:9090/` to test access).
