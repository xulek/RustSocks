...
- **Target**: >95% success rate, <7ms average handshake

#### 2. Concurrent Connections Test (5000)
- **Purpose**: Stress test with 5000 concurrent connections
- **Metrics**: Success rate, throughput, latency
- **Target**: >90% success rate, <10ms average handshake
...
- **Target**: >1000 sessions/second write throughput
...
|--------|--------|-------------|
| 1000 concurrent connections | >95% success | Connection success rate |
| 5000 concurrent connections | >90% success | Stress test success rate |
| Handshake latency | <7ms avg | SOCKS5 handshake time |
| ACL evaluation | <5ms | ACL decision time |
| Session tracking | <2ms | Session update overhead |
| DB write throughput | >1000/s | Sessions written to DB |
